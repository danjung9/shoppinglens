...
export declare class AgentHandoffItem {
    readonly id: string;
...
export declare class ChatContext {
    ...
    toProviderFormat(format: ProviderFormat, injectDummyUserMessage?: boolean): Promise<[Record<string, unknown>[], import("./provider_format/google.js").GoogleFormatData] | Record<string, any>[]>;
    /**
