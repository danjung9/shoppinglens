...
class RealtimeSession extends import_agents.llm.RealtimeSession {
  ...
  async onReceiveMessage(session, response) {
    ...
    if ((!this.currentGeneration || this.currentGeneration._done) && (response.serverContent || response.toolCall && ((_d = this.currentGeneration) == null ? void 0 : _d.functionChannel.closed) !== false)) {
